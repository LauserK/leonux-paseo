...
from .api import Sections, Stations, Devices, Sessions, Tickets, Report, Groups, Articles, AddArticleAccount, RemoveArticleAccount, RemoveAllArticleAccount, GetAllArticlesAccount, GetClientByQueue, UpdateClientStatus, UpdateClientSection, UpdateArticleQuantity, GenerateMovementDocument, LoginApi
...
urlpatterns = [
    ...
    # POS IOS
    url(r'^login/$', csrf_exempt(LoginApi.as_view()), name='login-api'),
